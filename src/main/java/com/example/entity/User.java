...
import com.example.domain.value_object.Email;
import com.example.domain.value_object.Password;
import com.example.domain.value_object.Role;
import com.example.domain.value_object.UserId;
import com.example.domain.value_object.UserName;
...
public class User {
	...
	public UserId id;
	public UserName name = new UserName("保下");
	public Email email;
